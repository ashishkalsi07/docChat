    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes('Email not confirmed')) {
          ...
          setMessage('We sent a confirmation email to your inbox. Please check and click the link to activate your account.')
        ...
        setMessage('🎉 Account created! Please check your email for the confirmation link to complete your registration.')
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center space-y-3">
            <p className="text-xs text-gray-500">
              By creating an account, you may need to verify your email address before signing in.
            </p>
            <Link
              href="/"
